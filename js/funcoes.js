...
// Parâmetros:
// - idNomeProduto: id do campo que contém o código do produto
...
// sucesso (todas as informações preencidas), chama a função cadastrarProduto(...)
//Retorno: nenhum
...
function validarProduto(idNomeProduto, idCodProduto, idQtidadeProduto) {
    ...
    if (nome == "")
        alert("Nome do produto não pode estar em branco. Favor preenche-lo!");
    else if (codigo == "")
        alert("Códogo do produto não pode estar em branco. Favor preenche-lo!");
...
// - codig: código do produto a sr cadastrado no estoque (Ex: a01)
